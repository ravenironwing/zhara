...
VEHICLES['tank'] = {'acceleration': 8, 'rot speed': 50,'hit sound': 'metal hit', 'hit rect': TANK_HIT_RECT, 'image': 1, 'damage': 10, 'cat': 'tank', 'weapons': 'tank mini gun', 'weapons2': None, 'layer': VEHICLE_LAYER, 'hp': 4000, 'walk animation': TANK, 'rattack animation': TANK, 'lattack animation': TANK, 'mountable': False}
