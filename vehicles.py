...
VEHICLES['tank'] = {'location': [64, 17, 59, 53], 'acceleration': 8,'hit sound': 'metal hit', 'hit rect': TANK_HIT_RECT, 'image': 1, 'cat': 'tank', 'weapons': 'tank mini gun', 'weapons2': None, 'layer': VEHICLE_LAYER, 'hp': 4000, 'walk animation': TANK, 'rattack animation': TANK, 'lattack animation': TANK, 'mountable': False}
