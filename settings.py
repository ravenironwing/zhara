...
EFFECTS_SOUNDS = {'bow reload': 'bow reload.wav', 'level_start': 'Day_1_v2_mod.ogg', 'click': 'click.wav', 'fanfare': 'fanfare.wav', 'rustle': 'rustle.wav', 'pickaxe': 'pickaxe.wav', 'rocks': 'rocks.wav', 'rock_hit': 'rock_hit.wav', 'fart': 'fart.wav', 'pee': 'pee.wav', 'toilet': 'toilet.wav',
                  ...
                  'knock.wav', 'metal hit': 'metal_hit.wav', 'anvil': 'anvil.wav', 'scrape': 'scrape.wav', 'grindstone': 'grindstone.wav', 'hammering': 'hammering.wav', 'snore': 'snore.wav', 'cashregister': 'cashregister.wav', 'alchemy': 'alchemy.wav', 'enchant': 'enchant.wav'}
...
DEFAULT_INVENTORIES = {}
DEFAULT_INVENTORIES['male osidine'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['decayed shirt M'], 'bottoms': ['jeans M'], 'gloves': [None], 'shoes': [None], 'gold': 0, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female osidine'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['decayed shirt F'], 'bottoms': ['grey yoga pants'], 'gloves': [None], 'shoes': [None], 'gold': 0, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male shaktele'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['pistol'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['tshirt M'], 'bottoms': ['jeans M'], 'gloves': [None], 'shoes': ['black combat'], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female shaktele'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['pistol'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['black racerback tank top'], 'bottoms': ['blue yoga pants'], 'gloves': [None], 'shoes': ['green combat'], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male elf'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['dark tshirt M'], 'bottoms': ['leather leggings M'], 'gloves': [None], 'shoes': ['black combat'], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female elf'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['red elf dress top'], 'bottoms': ['leaf skirt'], 'gloves': [None], 'shoes': ['green combat'], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male lacertolian'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bronze mace'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': ['leather leggings M'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female lacertolian'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bronze mace'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['red dress top'], 'bottoms': ['leather leggings F'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male immortui'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bone club'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['decayed shirt M'], 'bottoms': ['jeans M'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female immortui'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bone club'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['decayed shirt F'], 'bottoms': ['jeans F'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male miewdra'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['miewdra blade'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': ['leather leggings M'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female miewdra'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['miewdra blade'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['blue dress top'], 'bottoms': ['red mini dress skirt'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male mechanima'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['mechanima blaster'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female mechanima'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['mechanima blaster'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male whitewraith'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female whitewraith'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male skeleton'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female skeleton'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['male blackwraith'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
DEFAULT_INVENTORIES['female blackwraith'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': ['Guide book to Aroshay'], 'magic': [None]}
