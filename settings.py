...
GENDER['other'] = {'armor': 1,
                              'image': 2}
RACE = {}
RACE['osidine'] = {'armor': 1, 'image': 0, 'start map': (27, 39), 'start pos': (42, 54),
...
DEFAULT_INVENTORIES['female osidine'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['steel sword'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['leather armor F'], 'bottoms': ['leather leggings F'], 'gloves': [None], 'shoes': ['green combat'], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['male shaktele'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['pistol'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['tshirt M'], 'bottoms': ['jeans M'], 'gloves': [None], 'shoes': ['black combat'], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['female shaktele'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['pistol'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['black racerback tank top'], 'bottoms': ['blue yoga pants'], 'gloves': [None], 'shoes': ['green combat'], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['male elf'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['dark tshirt M'], 'bottoms': ['leather leggings M'], 'gloves': [None], 'shoes': ['black combat'], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['female elf'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['red elf dress top'], 'bottoms': ['leaf skirt'], 'gloves': [None], 'shoes': ['green combat'], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['male lacertolian'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bronze mace'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': ['leather leggings M'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['female lacertolian'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bronze mace'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['red dress top'], 'bottoms': ['leather leggings F'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['male immortui'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bone club'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['decayed shirt M'], 'bottoms': ['jeans M'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['female immortui'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['bone club'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['decayed shirt F'], 'bottoms': ['jeans F'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['male miewdra'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['miewdra blade'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': ['leather leggings M'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['female miewdra'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['miewdra blade'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': ['blue dress top'], 'bottoms': ['red mini dress skirt'], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['male mechanima'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['mechanima blaster'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['female mechanima'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': ['mechanima blaster'], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
DEFAULT_INVENTORIES['male whitewraith'] = {'gender': list(GENDER.keys()), 'race': list(RACE.keys()), 'weapons': [None], 'hats': [None], 'hair': list(HAIR.keys()), 'tops': [None], 'bottoms': [None], 'gloves': [None], 'shoes': [None], 'gold': 25, 'items': [None], 'magic': [None]}
