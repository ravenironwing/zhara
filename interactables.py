BREAKABLES = {}
BREAKABLES['carrot plant'] = {'break type': 'sudden', 'wobble': True, 'weapon required': 'sword', 'animate speed': 50, 'right weapon hit sound': 'rustle', 'hit sound': 'rustle', 'break sound': 'rustle', 'health': 1, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': True, 'items': {'carrot':2}, 'min drop': 1, 'rare items': ['green moth']}
BREAKABLES['potato bush'] = {'break type': 'sudden', 'wobble': True, 'weapon required': 'sword', 'animate speed': 50, 'right weapon hit sound': 'rustle', 'hit sound': 'rustle', 'break sound': 'rustle', 'health': 2, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': True, 'items': {'potato':3}, 'min drop': 1, 'rare items': ['red crystal', 'rabbit', 'green moth', 'snake', 'garden lizard']}
BREAKABLES['hedge'] = {'break type': 'sudden', 'wobble': True, 'weapon required': 'sword', 'animate speed': 50, 'right weapon hit sound': 'rustle', 'hit sound': 'rustle', 'break sound': 'rustle', 'health': 3, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': True, 'items': {'cut green wood':1}, 'rare items': ['red crystal', 'green moth', 'snake', 'garden lizard', 'green crystal']}
BREAKABLES['rose bush'] = {'break type': 'sudden', 'wobble': True, 'weapon required': 'sword', 'animate speed': 50, 'right weapon hit sound': 'rustle', 'hit sound': 'rustle', 'break sound': 'rustle', 'health': 3, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': True, 'items': {'yellow rose':5}, 'min drop': 1, 'rare items': ['yellow crystal', 'green moth', 'garden lizard', 'green crystal']}
BREAKABLES['fern'] = {'break type': 'sudden', 'wobble': True, 'weapon required': 'sword', 'animate speed': 50, 'right weapon hit sound': 'rustle', 'hit sound': 'rustle', 'break sound': 'rustle', 'health': 3, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': True, 'items': {'cut green wood':1}, 'rare items': ['blue crystal', 'green moth', 'snake', 'garden lizard', 'green crystal']}
...
BREAKABLES['empty turtle shell'] = {'break type': 'gradual', 'wobble': False, 'weapon required': 'mace', 'animate speed': 50, 'right weapon hit sound': 'rock_hit', 'hit sound': 'rock_hit', 'break sound': 'rocks', 'health': 2, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': True, 'items': {'turtle shell plate':12}, 'min drop': 4, 'rare items': ['bluefish']}
BREAKABLES['dead tree'] = {'break type': 'gradual', 'wobble': False, 'weapon required': 'axe', 'animate speed': 70, 'right weapon hit sound': 'rock_hit', 'hit sound': 'rock_hit', 'break sound': 'rocks', 'health': 5, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': False, 'items': {'cut dry wood':12}, 'rare items': ['dead brown bird']}
