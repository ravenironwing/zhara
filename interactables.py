...
BREAKABLES['rose bush'] = {'break type': 'sudden', 'wobble': True, 'weapon required': 'sword', 'animate speed': 50, 'right weapon hit sound': 'rustle', 'hit sound': 'rustle', 'break sound': 'rustle', 'health': 3, 'damage': 0, 'knockback': 0, 'protected': False, 'random drop number': True, 'items': {'yellow rose':5}, 'rare items': ['yellow crystal', 'green moth', 'garden lizard', 'green crystal']}
