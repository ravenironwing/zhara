...
PEOPLE['shakteleguard'] = {'name': 'Guard', 'protected': True, 'health': 600, 'touch damage': False, 'damage': 15, 'knockback': 10, 'walk speed': (190, 200), 'run speed': 260, 'detect radius': 1000, 'avoid radius': 130, 'aggression': 'awp', 'armed': True, 'dual wield': False,
    'collide': ['walls', 'water'],
    'gender': 'random', 'race': 'shaktele',
