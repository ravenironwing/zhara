...
GUARD_DLG = ['Watch it buddy!', 'I was once and adventurer like you then I took an arrow to the foot.', 'Don\'t try any funny business.']
ELF_GUARD_DLG = ['Hello, we are a peaceful people. Please do not use your weapons here.', 'You best be on your best behavior.']
VILLAGER_DLG = ['It\'s a fine day with you around.', 'Hi there.', 'Isn\'t it a lovely day?', 'Sometimes I wonder if I was abducted by aliens.']
...
ELF_QUEEN_DLG = ['Hello, my name is Zeladria. I am the queen of the elves.']
...
STEVE_DLG = ['I was running late for work today and I must have misplaced my weapon somewhere. The captain is going to be furious with me if you finds out. Will you please help me find a new mace?YN']
...
TAMOLIN_DLG2 = ['Hello trustworthy friend! How can I help you?', 'There are strange things going on in the graveyard south of here. There\'s no doubt some dark magic is responsible.']
